   ...
   <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li> 
         ...
         <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="daily.php">Daily Sales</a></li>
            <li><a class="dropdown-item" href="weekly.php">Weekly Sales</a></li>
            <li><a class="dropdown-item" href="monthly.php">Monthly Sales</a></li>
            <li><a class="dropdown-item" href="yearly.php">Yearly Sales</a></li>
         </ul>
      </li>
   </ul>
   <hr>
